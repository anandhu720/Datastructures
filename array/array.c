...
int main()
{
    ...
    arr.a[0]=1;arr.a[1]=2;arr.a[2]=0;arr.a[3]=4;arr.a[4]=9;
    arr.lenght=10;
    arr.size=10;

    struct array arr1;
    arr1.a=(int *)malloc(10*sizeof(int));          //array two
    arr1.a[0]=1;arr1.a[1]=3;arr1.a[2]=4;arr1.a[3]=5;arr1.a[4]=6;arr1.a[5]=8;arr1.a[6]=9;arr1.a[7]=10;arr1.a[8]=12;arr1.a[9]=14;
    arr1.lenght=10;
    arr1.size=10;
